...
fn main() {
    ...
    println!("For example, imagine I pass in 0b{:16b}. The next higher number with the same number of 1-bits is 0b{:16b}", x, next_highest_one_bits(x));
}

fn next_highest_one_bits(x: u16) -> u16 {
